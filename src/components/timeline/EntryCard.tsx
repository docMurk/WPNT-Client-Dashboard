  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`flex flex-col items-center gap-0.5 rounded-xl border border-wpnt-border bg-wpnt-card shadow-md px-3.5 pt-3.5 pb-2.5 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow select-none ${
