  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`flex flex-col items-center gap-0.5 rounded-xl border border-wpnt-border bg-wpnt-card shadow-lg px-1 pt-2 pb-1 overflow-hidden cursor-pointer hover:shadow-xl transition-shadow select-none ${
